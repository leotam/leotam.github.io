...
David Silver then gave one of the best presentations on deep reinforcement learning.  It was just the start of great presentations from Google Deepmind spanning the entire week.  He closed the sessions with details from their AlphaGo work.
...
G-convs as a drop-in replacement for standard convs, consistent improvements in accuracy and ties to Lie algebra.
...
SVRG is emerging as the most promising candidate to supersede stochastic gradient descent.
...
*Hopefully, this dynamic duo will continue their collaborations! <https://arxiv.org/abs/1511.07571>*
...
Training Region-based Object Detectors with Online Hard Example Mining to improve CNN object detection from Facebook AI (<https://arxiv.org/abs/1604.03540>) stirred some memories.  We had used hard positive mining to improve classifcation of retinal images (presentation [here][GTCretinopathy]).
